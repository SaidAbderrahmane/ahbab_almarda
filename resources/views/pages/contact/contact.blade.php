<x-app-layout>
    {{-- <section class="min-h-screen bg-gradient-to-r from-gray-600 via-gray-red to-red-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900"> --}}
        <section class="bg-gray-600 bg-cover bg-no-repeat bg-[url('https://images.unsplash.com/photo-1615461066159-fea0960485d5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1016&q=80')] bg-blend-multiply min-h-screen ">
        <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
            ...
            <div class="text-white lg:mx-6 lg:w-1/2">
                <h1 class="text-3xl font-semibold capitalize lg:text-5xl">Get in touch</h1>
            ...
            <div class="mt-8 lg:mx-6 lg:w-1/2">
                ...
                <form class="mt-6">
                    ...
                    <button class="mt-6 w-full transform rounded-md bg-gray-600 px-6 py-3 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-300 hover:bg-gray-700 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">get in touch</button>
                </form>
                </div>
            </div>
            </div>
        ...
        @include('pages.home.partials.footer')  
</x-app-layout>
