<footer class="bg-gray-100 dark:bg-gray-900">
    <div class="container mx-auto px-6 py-12">
        <div class="md:-mx-3 md:flex md:items-center md:justify-between">
            <h1 class="text-3xl font-semibold tracking-tight text-red-800 dark:text-white md:mx-3 xl:text-4xl">Register
                now and become a life saver.</h1>
            <div class="mt-6 shrink-0 md:mx-3 md:mt-0 md:w-auto">
                <a href="{{ route('register') }}"
                    class="inline-flex w-full items-center justify-center rounded-lg bg-red-700 px-4 py-2 text-sm text-white duration-300 hover:bg-red-800 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
    ...
    <div class=" sm:flex pb-10 sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://levelup-ds.com/"
                class="hover:underline">Levelup digital solutions</a>. All Rights Reserved.
        </span>
