<!-- Edit compaign-line Modal -->
<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
    id="edit-compaign-details-modal">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-compaign-details-modal">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('compaign-details.store') }}" method="POST" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <input type="hidden" id="key_operation" name="key_operation"
                        value="{{ $compaign->key_operation }}">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <div class="mt-7 ml-10">
                                <label class="relative inline-flex items-center mb-4 cursor-pointer">
                                    <input id="accepte" name="accepte" type="checkbox" value="O"
                                        class="sr-only peer">
                                    <div
