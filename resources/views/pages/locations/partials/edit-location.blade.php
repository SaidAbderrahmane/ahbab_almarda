                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <input type="hidden" value="" name="key_lieu" id="key_lieu">
                            <label for="nom_lieu"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Location name
                            </label>
                            <input type="text" name="nom_lieu" value="" id="nom_lieu"
