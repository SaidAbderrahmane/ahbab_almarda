<x-app-layout>
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">{{ __('Locations') }}</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{{ __('All locations') }}</h1>
            </div>
            @include('components.alerts')
            <div class="sm:flex">
                <div
                    class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ route('locations') }}" method="GET">
                        <div class="sm:flex">
                            <label for="locations-search" class="sr-only">Search</label>
                            <div class="relative mt-1 lg:w-64 xl:w-96">
                                <input type="text" name="q" id="locations-search" value="{{ request()->q }}"
                            ...
                            <div class="flex sm:mx-5 justify-between sm:my-0 my-5">
                                ...
                                <select id="order" name="order"
                                    ...
                                    <option {{ request()->order == 'nom_lieu-asc' ? 'selected' : '' }}
                                        value="nom_lieu-asc">
                                        {{__('location')}} {{ __('ascending') }}</option>
                                    <option {{ request()->order == 'nom_lieu-desc' ? 'selected' : '' }}
                                        value="nom_lieu-desc">
                                        {{__('location')}} {{ __('descending') }}</option>
                                </select>
                                <button type="submit"
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($locations as $location)
                                @include('pages.locations.partials.location-row')
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('pages.locations.partials.edit-location')
    @include('pages.locations.partials.add-location')
    @include('pages.locations.partials.delete-location')
