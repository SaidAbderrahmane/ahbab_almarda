 ...
 <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <div class="flex items-center justify-between mb-4">
      <div class="flex-shrink-0">
        <span id="total_compaigns" class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">total_compaigns</span>
        <h3 class="text-base font-light text-gray-500 dark:text-gray-400">{{__('Compaigns per year')}}</h3>
      </div>
    ...
    <div class="flex items-center justify-between pt-3 mt-4 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
      <div>
        ...
        <!-- Dropdown menu -->
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="weekly-donations-dropdown">
