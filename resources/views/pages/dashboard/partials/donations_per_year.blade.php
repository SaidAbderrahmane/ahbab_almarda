 ...
 <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <div class="flex items-center justify-between mb-4">
      <div class="flex-shrink-0">
        <span id="total_compaigns" class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">Total donations : {{$total_donations}}</span>
        <h3 class="text-base font-light text-gray-500 dark:text-gray-400">{{__('donations by cities')}}</h3>
      </div>

    </div>
    <div id="donations_per_year"></div>
    <!-- Card Footer -->
