<tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <td class="">
        <a type="button" href="{{ route('compaign-details', $compaign->key_operation) }}"
            data-id="{{ $compaign->key_operation }}">
            <div class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                <img class="w-10 h-10 rounded-full bg-blue-200" src="{{ asset('imgs/blood-donation2.png') }}"
                    alt="avatar">
                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        {{ str_pad($compaign->num_operation, 2, '0', STR_PAD_LEFT) }}</div>
                </div>
            </div>
        </a>
    </td>
    ...
    <td class="p-4 space-x-2 whitespace-nowrap">
        <button type="button" data-modal-toggle="edit-compaign-modal" data-id="{{ $compaign->key_operation }}"
        ...
        <button type="button" data-modal-toggle="delete-compaign-modal" data-id="{{ $compaign->key_operation }}"
        ...
        <a type="button" href="{{ route('compaign-details', $compaign->key_operation) }}"
            ...
            <svg class="w-4 h-4" fill="none" viewBox="2 0 20 20" xmlns="http://www.w3.org/2000/svg"
                stroke="currentColor">
                <path
